...
```http
GET https://raw.githubusercontent.com/Ksorgh/CSGO-API/main/public/api/{language}
```
...
```http
GET https://raw.githubusercontent.com/Ksorgh/CSGO-API/main/public/api/en/all.json
```
...
```http
GET https://raw.githubusercontent.com/Ksorgh/CSGO-API/main/public/api/en/skins.json
```
...
```http
GET https://raw.githubusercontent.com/Ksorgh/CSGO-API/main/public/api/en/skins_not_grouped.json
```
...
```http
GET https://raw.githubusercontent.com/Ksorgh/CSGO-API/main/public/api/en/stickers.json
```
...
```http
GET https://raw.githubusercontent.com/Ksorgh/CSGO-API/main/public/api/en/sticker_slabs.json
```
...
```http
GET https://raw.githubusercontent.com/Ksorgh/CSGO-API/main/public/api/en/keychains.json
```
...
```http
GET https://raw.githubusercontent.com/Ksorgh/CSGO-API/main/public/api/en/collections.json
```
...
```http
GET https://raw.githubusercontent.com/Ksorgh/CSGO-API/main/public/api/en/crates.json
```
...
```http
GET https://raw.githubusercontent.com/Ksorgh/CSGO-API/main/public/api/en/keys.json
```
...
```http
GET https://raw.githubusercontent.com/Ksorgh/CSGO-API/main/public/api/en/collectibles.json
```
...
```http
GET https://raw.githubusercontent.com/Ksorgh/CSGO-API/main/public/api/en/agents.json
```
...
```http
GET https://raw.githubusercontent.com/Ksorgh/CSGO-API/main/public/api/en/patches.json
```
...
```http
GET https://raw.githubusercontent.com/Ksorgh/CSGO-API/main/public/api/en/graffiti.json
```
...
```http
GET https://raw.githubusercontent.com/Ksorgh/CSGO-API/main/public/api/en/music_kits.json
```
...
```http
GET https://raw.githubusercontent.com/Ksorgh/CSGO-API/main/public/api/en/base_weapons.json
```
...
```http
GET https://raw.githubusercontent.com/Ksorgh/CSGO-API/main/public/api/en/highlights.json
```
